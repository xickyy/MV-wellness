import './ImmigrationPhysical.css';

const ImmigrationPhysical = () => {
  return (
    <div className='service-background-gradient'>
            <div className="service-background-gradient md:h-[60vh] w-full flex flex-col">
                <h2 className="text-center text-3xl py-6 underline">Immigration Physical</h2>
...
export default ImmigrationPhysical;
